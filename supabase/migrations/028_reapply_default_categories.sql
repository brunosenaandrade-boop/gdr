-- Reaplica migration 012 para garantir que categorias padrão tenham acento em produção.
-- QA Round 2 reportou novos tenants ainda recebendo "Alimentacao", "Saude" etc.
-- Esta migration é idempotente: repete CREATE OR REPLACE FUNCTION + UPDATE dos dados antigos.

-- 1. Corrigir registros existentes sem acento (PF)
...
-- 2. Corrigir registros existentes sem acento (PJ)
...
-- 3. Recriar function com acentos corretos (para NOVOS tenants)
